...
class BallDraw(object):
    ...
    def draw_ball(self):
        ...
        self.chart_1.create_oval(b.bounding_box(), fill=b.color)
    ...
    def animate(self):
        ...
        while b.some_inside(self.maxx,self.maxy):
            self.draw_ball()
            b.move()
            b.check_and_reverse(self.maxx,self.maxy)
