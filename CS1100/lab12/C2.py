...
def draw_plus(chart_1, rootx, rooty, length, level, maxlevel):
    if level == maxlevel:
        ...
        draw_plus(chart_1, left, rooty, length/2, level+1, maxlevel)
        draw_plus(chart_1, rootx, up, length/2, level+1, maxlevel)
        draw_plus(chart_1, right, rooty, length/2, level+1, maxlevel)
        draw_plus(chart_1, rootx, bottom, length/2, level+1, maxlevel)
