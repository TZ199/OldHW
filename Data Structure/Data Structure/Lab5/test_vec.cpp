...
//Test for Chcek point 1
  // cout << "Testing for c1" << endl;
  // Vec<int> t1;
  // t1.push_back(11);
  // t1.push_back(22);
  // t1.push_back(33);
  ...
  // t1.push_back(22);
  // unsigned int t2 = 0;
  // t2 = remove_matching_elements(t1,11);  
  // for(int i = 0; i < t1.size(); i++)
  // {
  //   cout<< t1[i] << endl;
  // }
  // cout << "return value  " << t2 << endl;

  // //Test for Check point2
  // Vec<int> t3;
  // for(int i =0; i<100; i++)
  // {
  //   t3.push_back(0);
  ...
  t4.push_back(33);
  t4.push_back(23);
  remove_matching_elements(t4,555);
  remove_matching_elements(t4,22);
  remove_matching_elements(t4,11);
  remove_matching_elements(t4,33);
  remove_matching_elements(t4,23);
